    ...
    $(document).ready(function () {
      ...
      $('.btn-add-to-cart').click(function () {
            ...
            addresses.forEach(function (address) {
                ...
                $form.find('select[name=address_id]')
                    .append("<option value='" + address.id + "'>" +
                        address.address + ' ' + address.contact_name + ' ' + address.contact_phone +
                        '</option>');
            });
        ...
        $('.btn-seckill').click(function () {
            ...
            addresses.forEach(function (address) {
                // 把当前收货地址添加到收货地址下拉框选项中
                addressSelector.append("<option value='" + address.id + "'>" + address.address + ' ' + address.contact_name + ' ' + address.contact_phone + '</option>');
            });
            // 调用 SweetAlert 弹框
            swal({
                text: '选择收货地址',
